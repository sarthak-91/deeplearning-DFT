from scripts.get_and_run_mols.molecule import Molecule
import numpy as np
import pandas as pd
import os
from sklearn.model_selection import train_test_split
from scripts.config import DATASETS_DIR, MOLECULE_CSV
...
def create_train_test(molecules:pd.DataFrame,
                npz_folder=DATASETS_DIR,dataset_folder=DATASETS_DIR,
...
def main():
    ...
    os.makedirs(DATASETS_DIR,exist_ok=True)
    create_train_test(molecules=molecules, npz_folder=DATASETS_DIR,dataset_folder=DATASETS_DIR)
